...
export default function FreteBotPage() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      await api.post("/enviar-cotacao", form);
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2 md:col-span-2">
                ...
                <select
                  ...
                  value={form.tipo}
                  onChange={handleChange}
                  className="w-full h-12 rounded-xl border border-slate-200 bg-white px-4 text-sm outline-none focus:border-blue-500 appearance-none"
                >
          ...
          <div className="text-center space-y-4">
            <button
              type="submit"
              disabled={loading}
              className="inline-flex h-14 items-center justify-center gap-2 rounded-2xl bg-blue-600 px-10 text-base font-bold text-white shadow-lg shadow-blue-200 transition hover:bg-blue-700 active:scale-[0.98]"
            >
